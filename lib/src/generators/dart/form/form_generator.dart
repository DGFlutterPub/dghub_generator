...
if(${model.key} != null$emptyCheck){
 _data.addEntries({"${model.key}": ${model.validate.isFile ? '''MultipartFile.fromBytes( 
...
await ${model.key}!.readAsBytes(),
  ...
  filename: ${model.key}!.name,
    ...
    read = read
        ...
        .replaceAll('/*formParameter*/', Tools.getNewLineString(formParameter))
        .replaceAll('/*formData*/', Tools.getNewLineString(formData));
